...
exports.RegistrationsModule = RegistrationsModule = __decorate([
    (0, common_1.Module)({
        controllers: [registrations_controller_1.PublicRegistrationController, registrations_controller_1.DiasporaVerificationController, registrations_controller_1.PujaCommitteeController],
    })
], RegistrationsModule);
