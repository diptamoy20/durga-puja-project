...
exports.ROLE_DEFINITIONS = [
    ...
    },
    {
        ...
        permissions: [
            ...
            permissions_1.PERMISSIONS.VIEW_SHARAD_SAMMAN, permissions_1.PERMISSIONS.VIEW_NOMINATIONS,
            permissions_1.PERMISSIONS.CREATE_NOMINATIONS, permissions_1.PERMISSIONS.EDIT_NOMINATIONS,
            permissions_1.PERMISSIONS.DELETE_NOMINATIONS, permissions_1.PERMISSIONS.MANAGE_NOMINATIONS,
            permissions_1.PERMISSIONS.REVIEW_NOMINATIONS, permissions_1.PERMISSIONS.APPROVE_NOMINATIONS,
            permissions_1.PERMISSIONS.SHORTLIST_NOMINATIONS, permissions_1.PERMISSIONS.VIEW_CONTESTS,
            permissions_1.PERMISSIONS.MANAGE_CONTESTS, permissions_1.PERMISSIONS.MANAGE_VOTING,
            permissions_1.PERMISSIONS.VIEW_VOTING_AUDIT, permissions_1.PERMISSIONS.EXPORT_SHARAD_SAMMAN,
        ],
    },
    {
