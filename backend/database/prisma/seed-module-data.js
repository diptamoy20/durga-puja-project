...
async function seedModuleData(prisma = new PrismaClient()) {
  ...
  console.log(`  Module data: ${diasporaCount} diaspora, ${committeeCount} committees, ${pandalCount} pandals, ${articleCount} articles, ${webinarCount} webinars, ${rsvpCount} RSVPs, ${nominationCount} nominations`);
}
